...
<head>
    ...
    <meta name="description" content="Page of Operator">
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ ($open == 'arsip') ? 'open active' : '' }} ">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item {{ $active == 'createArsip' ? 'active' :'' }} ">
                                <a href="{{ route('arsip.create') }}" class="menu-link">
                                        ...
                                        <span class="dropdown-item">
                                            <div class="d-flex">
                                                ...
                                                <div class="grow">
                                                    ...
                                                    <small class="text-muted">{{auth()->user()->bidang->nama_bidang}}</small> <br>
                                                </div>
                                            </div>
                                        </span>
                                    </li>
