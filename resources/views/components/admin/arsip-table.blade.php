             ...
             <div class="table-responsive">
                 <table class="table-striped" id="arsipTable">
                     ...
                     <tbody>
                             ...
                             <td style="font-size: small;" class="justify-content-center d-flex">
                                 <ul class="list-unstyled d-flex mb-0">
                                     ...
                                     <li
                                         ...
                                         class="pull-up"
                                         title="Detail">
                                         <a href="" class="mx-2 text-info" data-bs-toggle="modal" data-bs-target="#modalDetail-{{ $arsip->kode_arsip}}">
                                     ...
                                     <div class="modal-dialog modal-lg" role="document">
                                         <div class="modal-content">
                                             <div class="modal-header">
                                                 <h5 class="modal-title" id="exampleModalLabel1">Detail Arsip {{ $arsip->kode_arsip }}</h5>
                                                 <button
                                                     type="button"
                                                     class="btn-close"
                                             ...
                                             <div class="modal-body">
                                                 <div class="container">
                                                     ...
                                                     <div class="row mb-2">
                                                         <div class="col-4 fw-bold">Katgegori</div>
                                                     ...
                                                     <div class="row mb-2">
                                                         <div class="col-4 fw-bold">nama_file</div>
                         ...
                         @empty
                         <tr>
                             <td colspan="13" class="text-center">Tidak ada Arsip!</td>
                         </tr>
                         @endforelse
                     </tbody>
                 </table>
