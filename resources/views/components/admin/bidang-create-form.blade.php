...
<div class="row">
    <div class="card mb-4">
        <h5 class="card-header text-center">Add New Bidang</h5>
        <div class="card-body">
            <form action="{{ route('admin.bidang.store') }}" method="post" id="bidangForm">
                @csrf
                    ...
                    <div class="form-item border p-3 mb-3 rounded" data-index="0">
                        <div class="row mb-1">
                            <div class="col-md-8 mb-3">
                                ...
                                <input type="text" name="nama_bidang" class="form-control" value="{{ old('nama_bidang') }}" required placeholder="Nama Bidang">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Kode Bidang</label>
                                <input type="text" name="kode_bidang" class="form-control" value="{{ old('kode_bidang') }}" required placeholder="Kode Bidang">
                            </div>
                        </div>
                    </div>
                </div>
