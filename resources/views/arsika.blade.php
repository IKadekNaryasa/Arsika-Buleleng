...
<head>
    ...
    <title>ARSIKA Buleleng - Arsip Digital Kesbangpol Buleleng</title>
    <meta name="description" content="Sistem informasi yang dirancang untuk mengelola dan menyimpan data Arsip Kesbangpol Buleleng secara digital dan terstruktur. Dilengkapi dengan fitur sinkronisasi Google Drive.">
    <meta name="keywords" content="ARSIKA Buleleng, Arsip Digital, Kesbangpol Buleleng, Sistem Informasi Arsip, Badan Kesatuan Bangsa dan Politik Buleleng, Arsip Digital Pemerintah">
    <meta name="author" content="Prakom Kesbangpol Buleleng">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="http://103.226.139.107/">

    <meta property="og:type" content="website">
    <meta property="og:url" content="http://103.226.139.107/">
    <meta property="og:title" content="ARSIKA Buleleng - Arsip Digital Kesbangpol Buleleng">
    <meta property="og:description" content="Sistem informasi yang dirancang untuk mengelola dan menyimpan data Arsip Kesbangpol Buleleng secara digital dan terstruktur.">
    <meta property="og:image" content="http://103.226.139.107/img/arsika.png">
    <meta property="og:locale" content="id_ID">

    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="http://103.226.139.107/">
    <meta property="twitter:title" content="ARSIKA Buleleng - Arsip Digital Kesbangpol Buleleng">
    <meta property="twitter:description" content="Sistem informasi yang dirancang untuk mengelola dan menyimpan data Arsip Kesbangpol Buleleng secara digital dan terstruktur.">
    <meta property="twitter:image" content="http://103.226.139.107/img/arsika.png">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "http://103.226.139.107",
            "logo": "http://103.226.139.107/img/arsika.png",
            "description": "Sistem informasi yang dirancang untuk mengelola dan menyimpan data Arsip Kesbangpol Buleleng secara digital dan terstruktur. Dilengkapi dengan fitur sinkronisasi dengan Google Drive yang digunakan untuk menyimpan file arsip yang di upload.",
            "foundingDate": "2022-12-20",
            "address": {
                "@type": "PostalAddress",
    ...
    <script type="application/ld+json">
        {
            ...
            "description": "Aplikasi ARSIKA Buleleng adalah sistem informasi yang dirancang untuk mengelola dan menyimpan data Arsip Kesbangpol Buleleng secara digital dan terstruktur.",
            "featureList": [
                "Database Terpusat - Semua data Arsip tersimpan dalam satu sistem",
                "Cetak Laporan Tahunan - Cetak laporan arsip tahunan dengan lebih mudah",
                "Sinkronisasi dengan Google Drive untuk menyimpan file arsip"
            ],
            "screenshot": "http://103.226.139.107/img/arsika.png"
        }
    </script>
...
<body class="bg-gray-50">
    ...
    <main>
        <div class="container mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:py-2">
            <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                <!-- Content -->
                <article class="space-y-4 sm:space-y-6 flex flex-col justify-center">
                    <header class="text-center lg:text-left">
                        <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-800 mb-2">ARSIKA</h1>
                        <h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-600 mb-4 sm:mb-6">Buleleng</h2>
                    </header>
                    ...
                    <section class="bg-white p-4 sm:p-6 rounded-xl shadow-lg border border-gray-100">
                        <h3 class="font-semibold text-gray-800 mb-3 flex items-center justify-center lg:justify-start text-sm sm:text-base">
    ...
    <footer class="bg-gray-800 text-white py-6 sm:py-8">
        <div class="container mx-auto px-4 sm:px-6 text-center">
            <p class="text-gray-400 text-xs sm:text-base">&copy; 2025 - {{ date('Y') }} ARSIKA Buleleng. Prakom Kesbangpol</p>
        </div>
    </footer>
</body>
