            ...
            <div class="space-y-4 sm:space-y-6 flex flex-col justify-center">
                ...
                <div class="bg-white p-4 sm:p-6 rounded-xl shadow-lg border border-gray-100">
                    ...
                    <p class="text-gray-600 leading-relaxed text-sm sm:text-base text-center lg:text-left">
                        Aplikasi <span class="font-semibold text-blue-600">ARSIKA Buleleng</span> adalah sistem informasi yang dirancang untuk mengelola dan menyimpan data Arsip Kesbangpol Buleleng secara digital dan terstruktur.
                    </p>
                    <p class="text-gray-600 leading-relaxed mt-3 text-sm sm:text-base text-center lg:text-left">
                        Dilengkapi dengan fitur <span class="font-semibold text-orange-600">Sinkronisasi dengan Google Drive</span> yang digunakan untuk menyimpan file arsip yang di upload
                    </p>
                </div>
            </div>

            <!-- Illustration -->
            <div class="relative order-first lg:order-last flex justify-center lg:justify-end">
                <div class="relative z-10">
                    <img src="{{ asset('img/arsika.png') }}" alt="Data Management Illustration" class="w-80 h-auto drop-shadow-2xl">
                </div>
                <!-- Decorative Elements -->
        ...
        <div class="container mx-auto px-4 sm:px-6">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
                ...
                <div class="text-center p-4 sm:p-6 rounded-xl hover:shadow-xl transition duration-300 border border-gray-100">
                    ...
                    <h4 class="font-bold text-base sm:text-lg mb-2 text-gray-800">Cetak Laporan Tahunan</h4>
